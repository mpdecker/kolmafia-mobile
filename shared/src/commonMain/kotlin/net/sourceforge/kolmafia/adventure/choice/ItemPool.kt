...
object ItemPool {
    ...
    const val STAR_KEY                  = 665
    const val DIGITAL_KEY               = 691
    const val CLOWN_CAR_KEY             = 10547
    const val BATTING_CAGE_KEY          = 10548
    const val AQUI                      = 10549
    const val KNOB_LABINET_KEY          = 10550
    const val WEREMOOSE_KEY             = 10551
    const val PEG_KEY                   = 10552
    const val KEKEKEY                   = 10553
    const val RABBITS_FOOT_KEY          = 10554
    const val KNOB_SHAFT_SKATE_KEY      = 10555
    const val ICE_KEY                   = 10556
    const val ANCHOVY_CAN_KEY           = 10557
    const val CACTUS_KEY                = 10558
    const val F_C_LE_SH_C_LE_K_Y        = 10559
    const val TREASURE_CHEST_KEY        = 10560
    const val DEMONIC_KEY               = 10561
    const val KEY_SAUSAGE               = 10562
    const val KNOB_TREASURY_KEY         = 10563
    const val SCRAP_METAL_KEY           = 10564
    const val BLACK_ROSE_KEY            = 10565
    const val MUSIC_BOX_KEY             = 10566
    const val ACTUAL_SKELETON_KEY       = 10567
    const val DEEP_FRIED_KEY            = 10568
    const val DISCARDED_BIKE_LOCK_KEY   = 10569
    const val RUFUS_SHADOW_LODESTONE    = 11176
    ...
    val MISTRESS_ITEM_IDS: IntArray = intArrayOf(
