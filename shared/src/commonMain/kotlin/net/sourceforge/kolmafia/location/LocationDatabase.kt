...
object LocationDatabase {
    ...
    val ALL_LOCATIONS: List<LocationData> = listOf(
        ...
        LocationData("296", "A-Boo Peak",                            "The Big Mountains",           7),
        ...
        LocationData("132", "The Battlefield (Frat Uniform)",        "The Mysterious Island",       9),
        LocationData("140", "The Battlefield (Hippy Uniform)",       "The Mysterious Island",       9),
