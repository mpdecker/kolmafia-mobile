...
/** Desktop consequences.txt COMBAT_SKILL rows — applied to fight dropdown option labels. */
@OptIn(ExperimentalResourceApi::class)
object CombatSkillConsequenceDatabase {
    ...
    private fun parse(text: String): Map<Int, List<ConsequenceRule>> {
        ...
        for (raw in text.lines()) {
            ...
            if (parts.size < 4 || parts[0] != "COMBAT_SKILL") continue
