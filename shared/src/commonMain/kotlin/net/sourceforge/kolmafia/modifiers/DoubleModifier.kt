...
enum class DoubleModifier(
    ...
    companion object {
        ...
        private val ENCHANTMENTS = setOf(
            ACCESSORYDROP, ADDITIONAL_SONG, ADVENTURES, ALL_ATTRIBUTES, ALL_ATTRIBUTES_PCT,
            BOOZEDROP, BUGBEAR_DAMAGE, CANDYDROP, COLD_DAMAGE, COLD_RESISTANCE, COLD_SPELL_DAMAGE,
            COMBAT_MANA_COST, COMBAT_RATE, CRITICAL_PCT, DAMAGE_ABSORPTION, DAMAGE_REDUCTION,
            DB_COMBAT_DAMAGE, DISCO_STYLE, DRIPPY_DAMAGE, ELF_WARFARE_EFFECTIVENESS, EXPERIENCE,
            FAMILIAR_DAMAGE, FAMILIAR_EXP, FAMILIAR_WEIGHT, FISHING_SKILL, FOODDROP, FUMBLE,
            GHOST_DAMAGE, HATDROP, HAT_PANTS_DROP, HOBO_POWER, HOT_DAMAGE, HOT_RESISTANCE,
            HOT_SPELL_DAMAGE, HP, HP_PCT, HP_REGEN_MAX, HP_REGEN_MIN, INITIATIVE, ITEMDROP,
            MANA_COST, MAXIMUM_HOOCH, MAXIMUM_HP_MP, MEATDROP, MERKIN_DAMAGE, MONSTER_LEVEL,
            MOX, MOX_EXPERIENCE, MOX_EXPERIENCE_PCT, MOX_LIMIT, MOX_PCT, MP, MP_PCT,
            MP_REGEN_MAX, MP_REGEN_MIN, MUS, MUS_EXPERIENCE, MUS_EXPERIENCE_PCT, MUS_LIMIT, MUS_PCT,
            MYS, MYS_EXPERIENCE, MYS_EXPERIENCE_PCT, MYS_LIMIT, MYS_PCT, ORC_DAMAGE, OTHELLO_SKILL,
            PANTSDROP, PICKPOCKET_CHANCE, PIRATE_WARFARE_EFFECTIVENESS, POTION_DROP, PVP_FIGHTS,
            RANDOM_MONSTER_MODIFIERS, RANGED_DAMAGE, RANGED_DAMAGE_PCT, REDUCE_ENEMY_DEFENSE,
            SKELETON_DAMAGE, SLEAZE_DAMAGE, SLEAZE_RESISTANCE, SLEAZE_SPELL_DAMAGE, SLIME_RESISTANCE,
            SMITHSNESS, SPELL_CRITICAL_PCT, SPELL_DAMAGE, SPELL_DAMAGE_PCT, SPLEEN_DROP,
            SPOOKY_DAMAGE, SPOOKY_RESISTANCE, SPOOKY_SPELL_DAMAGE, STENCH_DAMAGE, STENCH_RESISTANCE,
            STENCH_SPELL_DAMAGE, SUPERCOLD_RESISTANCE, VAMPIRE_DAMAGE, WARBEAR_ARMOR_PENETRATION,
            WEAPONDROP, WEAPON_DAMAGE, WEAPON_DAMAGE_PCT, WEREWOLF_DAMAGE, ZOMBIE_DAMAGE,
        )
