...
object ModifierEnchantmentParser {
    ...
    private val DOUBLE_DESC: List<DescPattern<DoubleModifier>> = listOf(
        ...
        DescPattern(DoubleModifier.ALL_ATTRIBUTES_PCT, Regex("All Attributes ([+-]\\d+)%$")),
        DescPattern(DoubleModifier.ALL_ATTRIBUTES, Regex("All Attributes ([+-]\\d+)$")),
        DescPattern(DoubleModifier.MAXIMUM_HP_MP, Regex("Maximum HP/MP ([+-]\\d+)$")),
        ...
        DescPattern(DoubleModifier.HAT_PANTS_DROP, Regex("([+-]\\d+)% Hat/Pants Drops? [Ff]rom Monsters$")),
        DescPattern(DoubleModifier.HATDROP, Regex("([+-]\\d+)% Hat Drops? [Ff]rom Monsters$")),
        ...
        DescPattern(DoubleModifier.PANTSDROP, Regex("([+-]\\d+)% Pants Drops? [Ff]rom Monsters$")),
