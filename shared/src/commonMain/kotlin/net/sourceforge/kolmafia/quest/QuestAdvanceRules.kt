...
object QuestAdvanceRules {
    ...
    private val rules = listOf(
        ...
        Rule(Quest.PIRATEREALM.prefKey, "step1", "sail1.gif", requiresStep = QuestDatabase.STARTED),
        Rule(Quest.PIRATEREALM.prefKey, "step6", "sail2.gif"),
        Rule(Quest.PIRATEREALM.prefKey, "step11", "sail3.gif"),
