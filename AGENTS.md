...
- Phase plans live under `docs/superpowers/plans/`; ASH batches in `GameRuntimeLibrary.AshP*Batch.kt` — AshP8–P18 registration floor, AshP19–AshP60 live behavioral batches (entity `to_*` resolvers, `$entity[field]` bracket reads via `*EntityFields.kt` including MONSTER/LOCATION/PATH fields + `$monster[base_mainstat_exp]` + `$monster[*_resistance]` + `$monster[raw_*]`, AshP39 `CombatAdjustment`, AshP40 drop/XP/initiative modifiers, AshP41–43 monster combat stats/element/`jump_chance`, AshP44 location `jump_chance`, AshP45 `meat_drop`/`item_drops`, AshP46 hit/miss combat APIs, AshP47 `all_monsters_with_id`, AshP48 jump Init polish, AshP49–52 expression Init/Atk/Def/HP eval, AshP53–54 numeric/expression Scale/Cap/Floor + `equipped()`, AshP55 Exp / `base_mainstat_exp`, AshP56 `REDUCE_ENEMY_DEFENSE`, AshP57 Phys/Elem resistance brackets, AshP58 `MLMult:` effective ML, AshP59 ML phys-res boost, AshP60 raw_* brackets, modifier lookups via `modifiers/*`; roadmap: `2026-06-11-ash-script-full-parity.md`).
...
- Incremental parity phases use Quest/CLI/Maximizer tracks; Phases 53–102 advanced Tier 1 (AshP19–AshP60 entity/modifier/monster/combat libraries including MONSTER/LOCATION/PATH brackets, combat adjustment, drop/XP/initiative/meat/item drops, monster combat stats/element/`jump_chance`, location `jump_chance`, hit/miss APIs, `all_monsters_with_id`, expression Init/Atk/Def/HP, numeric + expression Scale/Cap/Floor, Exp/`base_mainstat_exp`, `REDUCE_ENEMY_DEFENSE`, Phys/Elem resistance brackets, `MLMult:` effective ML, ML phys-res boost, `$monster[raw_*]`, CLI long-tail including `journey`/`witchess`/`volcano`, charpane sync for Ed/VYKEA/pasta thrall, tower/hedge maze/PirateRealm sync); `GameRuntimeLibrary.REVISION` uses `phaseNN` format (currently `phase102`); update `docs/parity-audit.md` after each phase.
